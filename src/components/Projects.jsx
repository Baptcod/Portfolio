  ...
  const projects = [
    {
      ...
      github: "https://github.com/Baptcod/Portfolio",
      image: "/project1.jpg"
    },
    {
    ...
    },
    {
      ...
      doc: "/documents/Doc-AutomatedLab.pdf",
            ...
            <div key={index} className="grid grid-cols-1 lg:grid-cols-5 gap-8 items-center group">
              <div className="lg:col-span-3 order-2 lg:order-1">
                ...
                <div className="flex gap-4 items-center">
                  {project.github && (
                    <a href={project.github} target="_blank" rel="noopener noreferrer" className="text-lightest-slate hover:text-green transition-colors">
                  ...
                  {project.live && (
                    <a href={project.live} target="_blank" rel="noopener noreferrer" className="text-lightest-slate hover:text-green transition-colors">
